                    ...
                    <div class="col-md-12  pright pleft">
                      <div class="editprofile">
                        <ul>
                          ...
                          <li><a href="{{url('/viewbookedflightnew')}}"  class="active1">حجوزات رحلات الطيران</a></li>
                ...
                <div class="col-md-12">
                  <div class="multipal1">
                    <ul>
                      ...
                      <li class="widthli3"><a href="{{ url('/viewbookedflightnewone/'.$appointment->id)}}" class="btn btn-edit colorveiw" style="color:white">مشاهدة</a></li>
                    </ul>
                  </div>
                </div>
              </div>
