                    ...
                    <div class="col-md-12  pright pleft">
                      <div class="editprofile">
                        <ul>
                          ...
                          <li><a href="{{url('/bookednew')}}" class="active1" style="<?php if($company->addpackage != 'on'){echo 'display:none';}?>">العروض التي تمّ حجزها (خاص بالشركات)</a></li>
                ...
                <div class="col-md-12">
                  <div class="multipal3 mainwidthulbooking">
                    <ul>
                      ...
                      <li class="adult"  style="width:6%!important;">طفل</li>
                      <li class="adult"  style="width:6%!important;">رضيع</li>
                      <li style="width:18%!important;">تاريخ الحجز</li>
                      <li style="width:28%!important;">تفاصيل وحالة الحجز</li>
                    </ul>
                  </div>
                </div>
              </div>
                ...
                <div class="col-md-12">
                  <div class="multipal1">
                    <ul>
                      ...
                      <li><input type="text" name="text" placeholder="Turkey" readonly value="{{$appointment->name}}"></li>
                      ...
                      <li class="widthli3">
                        <a href="{{ url('/viewbookednewone/'.$appointment->id)}}" class="btn btn-edit colorveiw" style="color:white">مشاهدة</a>
                        <?php if($appointment->status == 'good'){?>
                        <a href="{{ url('/checkbookednewone/'.$appointment->id)}}" class="btn btn-edit colorveiw" style="color:white;    background-color: dimgrey!important;">بالانتظار</a>
                        <?php }else {?>
