    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 pright">
                <div class="box">
                    ...
                    <div class="row rowmar bgcolorbox3 account">
                        <div class="col-md-12">
                            <div class="circle">
                                <img src="{{asset('addbyme/images/cicle.jpeg')}}">
                            </div>
            ...
            <div class="col-md-8 pleft">
                <form method="POST" action="{{url('updatepackagenew')}}"  enctype="multipart/form-data">
                @csrf 
                    ...
                    <div class="bookingname">
                        ...
                        <div class="row rowmar">
                            <div class="col-md-6">
                                <div class="bookform1">
                                    <label>الدولة</label>
                                    <div class="bginpt">
                                        <input type="text" name="country" required list="offercountry" id="offercountryinput" class="mainheit mainheit3" value="{{$package->country}}">
                            ...
                            <div class="col-md-6">
                                <div class="bookform1">
                                    <label>المدينة </label>
                                    <div class="bginpt">
                                        <input type="text" list="offercity" name="city" required class="mainheit mainheit3" value="{{$package->city}}">
                                        <datalist id="offercity">
                                            <?php foreach($offercities as $offercity){?>
                                                <option value="{{$offercity->arabic}}">{{$offercity->arabic}}</option>
                                            <?php }?>
                                        </datalist>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="bookform1 bookform2">
                                    ...
                                    <input type="date" name="from" min="<?php echo date('Y-m-d'); ?>" max="<?php echo date('Y-m-d', strtotime("+1 year")); ?>" placeholder="08/01/2019" required value="{{$package->from}}"  >
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="bookform1 bookform2">
                                    <label>الى</label>
                                    <span class="map1"><i class="fa fa-calendar"></i></span>
                                    <input type="date" name="until"   min="<?php echo date('Y-m-d'); ?>" max="<?php echo date('Y-m-d', strtotime("+1 year")); ?>" placeholder="08/01/2019" required  value="{{$package->until}}" >
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="bookform1">
                                    ...
                                    <input type="hidden"  value="{{$package->star}}" name="star" id="numberstar">
                                    <ul class="star1">
                                        <li class="forstar <?php if($package->star > 0){echo 'star';}?>"><input type="hidden" value="1" ><i class="fa fa-star"></i></li>
                                        <li class="forstar <?php if($package->star > 1){echo 'star';}?>"><input type="hidden" value="2" ><i class="fa fa-star"></i></li>
                                        <li class="forstar <?php if($package->star > 2){echo 'star';}?>"><input type="hidden" value="3" ><i class="fa fa-star"></i></li>
                                        <li class="forstar <?php if($package->star > 3){echo 'star';}?>"><input type="hidden" value="4" ><i class="fa fa-star"></i></li>
                                        <li class="forstar <?php if($package->star > 4){echo 'star';}?>"><input type="hidden" value="5" ><i class="fa fa-star"></i></li>
                                    </ul>
                                </div>
                        ...
                        <div class="row rowmar">
                            <div class="col-md-12">
                                <div class="bookform1">
                                    ...
                                    <textarea class="form-control" rows="2" required name="hotelname">{{$package->hotelname}}</textarea>
                                </div>
                            </div>
                        ...
                        <div class="row rowmar">
                            <div class="col-md-12">
                                ...
                                <div class="bookform1 mainbooking2">
                                    ...
                                    <textarea class="form-control" rows="2" name="subject" placeholder="على سبيل المثال: 10 أيام في تركيا بمنطقة الفاتح" required>{{$package->subject}}</textarea>
                                </div>
                            </div>
                        ...
                        <div class="row rowmar">
                            <div class="col-md-12">
                                <div class="bookform1 inputwidth3">
                                    ...
                                    <input type="text"  placeholder="0" name="seat" required value="{{$package->seat}}">
                                            ...
                                            <div class="col-md-8">
                                                <div class="uploadboximages">
                                                    ...
                                                    <div class="avatar-preview">
                                                        <?php if($package->doc != ''){?>
                                                        <div id="imagePreview" style="background-image : url({{asset('addbyme/images/uploadimages2.png')}})">
                        ...
                        <div class="row rowmar">
                            <div class="col-md-3">
                                <div class="bookform1 timeout">
                                    ...
                                    <div class="clock3">
                                        <input type="time" name="departure_time" id="departure_time" placeholder="10:00" value="{{$package->departure_time}}">
                            ...
                            <div class="col-md-3">
                                <div class="bookform1 timeout">
                                    ...
                                    <div class="clock3">
                                        <input type="time" name="arrival_time"  id="arrival_time" placeholder="11:00" value="{{$package->arrival_time}}">
                                        <i class="fa fa-clock-o"></i>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="bookform1 timeout">
                                    ...
                                    <div class="clock3">
                                        <input type="text" name="departure_airport" placeholder="IST" value="{{$package->departure_airport}}">
                            ...
                            <div class="col-md-3">
                                <div class="bookform1 timeout">
                                    ...
                                    <div class="clock3">
                                        <input type="text" name="arrival_airport" placeholder="IST" value="{{$package->arrival_airport}}">
                            ...
                            <div class="col-md-4">
                                <div class="bookform1 timeout">
                                    ...
                                    <div class="clock3">
                                        <input type="text" name="airline" placeholder="Turkish Airlines" value="{{$package->airline}}">
                        ...
                        <div class="row rowmar">
                            <div class="col-md-3">
                                <div class="bookform1 timeout">
                                    <label>وقت المغادرة</label>
                                    <div class="clock3">
                                        <input type="time" name="departure_time_1" id="departure_time_1" placeholder="10:00" value="{{$package->departure_time_1}}">
                                        <i class="fa fa-clock-o"></i>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="bookform1 timeout">
                                    <label>وقت الوصول </label>
                                    <div class="clock3">
                                        <input type="time" name="arrival_time_1" id="arrival_time_1"  placeholder="11:00" value="{{$package->arrival_time_1}}">
                                        <i class="fa fa-clock-o"></i>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="bookform1 timeout">
                                    <label>المغادرة من مطار</label>
                                    <div class="clock3">
                                        <input type="text" name="departure_airport_1" placeholder="IST" value="{{$package->departure_airport_1}}">
                            ...
                            <div class="col-md-3">
                                <div class="bookform1 timeout">
                                    <label>الوصول الى مطار</label>
                                    <div class="clock3">
                                        <input type="text" name="arrival_airport_1" placeholder="IST" value="{{$package->arrival_airport_1}}">
                            ...
                            <div class="col-md-4">
                                <div class="bookform1 timeout">
                                    <label>شركة الطيران</label>
                                    <div class="clock3">
                                        <input type="text" name="airline_1" placeholder="Turkish Airlines" value="{{$package->airline_1}}">
                        ...
                        <div class="row rowmar paddro">
                            <div class="col-md-4">
                                <div class="bookform1 bookform2">
                                    <label>من</label>
                                    <span class="map1"><i class="fa fa-calendar"></i></span>
                                    <input type="date"   name="offer_from"   value="{{$package->offer_from}}" required >
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="bookform1 bookform2">
                                    <label>الى</label>
                                    <span class="map1"><i class="fa fa-calendar"></i></span>
                                    <input type="date"   name="offer_until"  value="{{$package->offer_until}}"  min="<?php echo date('Y-m-d'); ?>" max="<?php echo date('Y-m-d', strtotime("+1 year")); ?>"  required >
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-check maincolorlableinput">
                                    <label class="form-check-label maincolorlable"  for="radio4">
                                        <input type="checkbox" class="form-check-input" name="special" value="special" id="radio4" <?php if($package->special == 'special'){echo 'checked';}?>> <span>هل هو عرض خاص؟</span>
                                    </label>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="dayinline">
                                    ...
                                    <div class="form-check-inline">
                                        <label class="form-check-label" for="radio3">
                                            <input type="radio" class="form-check-input" id="radio3" name="day" value="one" <?php if($package->day == 'one'){echo 'checked';}?>> <span>5 دولارات لليوم الواحد</span>
                                        </label>
                                    </div>

                                    <div class="form-check-inline">
                                        <label class="form-check-label" for="radio2">
                                            <input type="radio" class="form-check-input" id="radio2" name="day" value="two" <?php if($package->day == 'two'){echo 'checked';}?>> <span>يومين 8 دولارات</span>
                                        </label>
                                    </div>

                                    <div class="form-check-inline">
                                        <label class="form-check-label" for="radio1">
                                            <input type="radio" class="form-check-input" id="radio1" name="day" value="three" <?php if($package->day == 'three'){echo 'checked';}?>> <span>3 أيام 12 دولار</span>
                                        </label>
                                    </div>
                        ...
                        <div class="row rowmar paddro">
                            <div class="col-md-4">
                                <div class="bookform1 bookform2">
                                    ...
                                    <input type="number"  placeholder="$1100"  name="adult" value="{{$package->adult}}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="bookform1 bookform2">
                                    ...
                                    <input type="number"  placeholder="$500"  name="child" value="{{$package->child}}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="bookform1 bookform2">
                                    ...
                                    <input type="number"  placeholder="$200"  name="infant" value="{{$package->infant}}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-2">
                                <div class="bookform1 bookform2">
                                    <label>تحديد </label>
                                <input type="checkbox"     name="singlestatus"  style="height: 30px; margin-top: 18px;" value="on" <?php if($package->singlestatus == 'on'){echo 'checked';}?>>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="bookform1 bookform2">
                                    <label>السنكل</label>
                                <input type="number"  placeholder="$1300"  name="single" value="{{$package->single}}" >
                                </div>
                            </div>
                            <div class="col-md-6">
                            </div>
                            <div class="col-md-2">
                                <div class="bookform1 bookform2">
                                    <label>تحديد</label>
                                <input type="checkbox"    name="childbedstatus"  style="height: 30px; margin-top: 18px;" value="on"<?php if($package->childbedstatus == 'on'){echo 'checked';}?>>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="bookform1 bookform2">
                                    <label>طفل بسرير</label>
                                <input type="number"  placeholder="$600"  name="childbed"  value="{{$package->childbed}}">
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="bookform1 bookform2">
                                    <label>تحديد </label>
                                <input type="checkbox"     name="roomstatus"  style="height: 30px; margin-top: 18px;" value="on" <?php if($package->roomstatus == 'on'){echo 'checked';}?>>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="bookform1 bookform2">
                                    <label>غرفة اضافية</label>
                                <input type="number"  placeholder="$1300"  name="room" value="{{$package->room}}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="bookform1 bookform2">
                                    <label>التسديد</label>
                                    <input type="number" name="wesell" placeholder="$1100"  value="{{$package->wesell}}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="bookform1 bookform2">
                                    ...
                                    <input type="number" name="yousell" placeholder="$1300"  value="{{$package->yousell}}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row rowmar">
                            <div class="col-md-12">
                                <div class="bookform1 mainbooking2">
                                    ...
                                    <textarea class="form-control" rows="5" name="more_details" placeholder="تفاصيل الرحلة من برنامج وخدمات" required>{{$package->more_details}}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row rowmar">
                        ...
                        <div class="row rowmar">
                            <div class="col-md-12 image_preview">
                                <?php foreach($package_photos as $package_photo){?>
                                    <img class="image_preview_img" src="{{asset('upload/package/'.$package_photo->photo)}}" >
                                <?php }?>
                            </div>
                        </div>   
