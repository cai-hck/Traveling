...
<div class="maindiv" style="width:100%; margin: auto; background-color:#FBFCFD; padding: 0px 15px;">
        ...
        <tbody>
            <tr>
                ...
                <td colspan="2" style="text-align:right;width:50%;">
                  <span style="color:#253858; background-color:#FFE380; padding: 2px 10px; font-size:12px;font-weight:bold; letter-spacing: 1px; text-transform:capitalize;">{{$package->country}}</span>
                  <span style="color:#253858; background-color:#FFE380; padding: 2px 10px; font-size:12px;font-weight:bold; letter-spacing: 1px; text-transform:capitalize;">{{$package->id}}</span>
                </td>
            </tr>
        </tbody>
    </table>
        ...
        <tbody>
            <tr>
                <td style="width:33%;">
                    ...
                    <br/> 
                    <input style="background-color:#F0F0F0; border: 0px;padding: 13px 10px;text-align: center; width:33%;"type="text" name="text" value="{{$package->departure_airport}}">
                </td>
                <td style="width:33%;">
                    <span style="font-size:14px; font-weight:bold; color:#253858; letter-spacing:1px;">To</span>
                    <br/> 
                    <input style="background-color:#F0F0F0; border: 0px;padding: 13px 10px;text-align: center;width:33%;"type="text" name="text" value="{{$package->arrival_airport}}">
                </td>
                <td style="width:33%;">
                    <span style="font-size:14px; font-weight:bold; color:#253858; letter-spacing:1px; ">Flight</span>
                    <br/> 
                    <input style="background-color:#F0F0F0; border: 0px;padding: 13px 10px;text-align: center;width:33%;"type="text" name="text" value="123456">
                </td>
            </tr>
            <tr>
                <td  style="width:33%;">
                    ...
                    <br/>
                    <input style="background-color:#F0F0F0; border: 0px;padding: 13px 10px;text-align: center;width:33%;"type="text" name="text" value="{{$package->from}}">
                </td>
                <td style="width:33%;">
                    <span style="font-size:14px; font-weight:bold; color:#253858; letter-spacing:1px; ">Departure Time</span>
                    <br/>
                    <input style="background-color:#F0F0F0; border: 0px;padding: 13px 10px;text-align: center;width:33%;"type="text" name="text" value="{{$package->departure_time}}">
                </td>
                <td style="width:33%;">
                    <span style="font-size:14px; font-weight:bold; color:#253858; letter-spacing:1px; ">ArrivalTime</span>
                    <br/> 
                    <input style="background-color:#F0F0F0; border: 0px;padding: 13px 10px;text-align: center;width:33%;"type="text" name="text" value="{{$package->arrival_time}}">
                </td>
            </tr>
            <tr>
                <td  style="width:33%;">
                    ...
                    <br/> 
                    <input style="background-color:#F0F0F0; border: 0px;padding: 13px 10px;text-align: center;width:33%;"type="text" name="text" value="{{$package->airline}}">
                </td>
                <td  style="width:33%;">
                ...
                <td  style="width:33%;">
                    <span style="font-size:14px; font-weight:bold; color:#253858; letter-spacing:1px; ">Hotel</span>
                    <br/> 
                    <input style="background-color:#F0F0F0; border: 0px;padding: 13px 10px;text-align: center;width:33%;"type="text" name="text" value="{{$package->hotelname}}">
                </td>
            </tr>
        </tbody>
    </table>
    <table class="table-responsive" style="width:100%;border-collapse: collapse;">
        <tbody>
            <tr>
                <td colspan="3" style="background-color:#1561A8; color:#fff;">
                    <span style="display: flex;padding: 10px 5px 5px 5px; font-size:14px; font-weight:800;letter-spacing:1px;">Return Information <img style="padding-left:6px; position: relative;top: -5px;width:30px;" src="{{$path_image3.'Group.png'}}"></span>
                </td>
            </tr>
        </tbody>
    </table>
        ...
        <tbody>
            <tr>
                <td style="width:33%;">
                    <span style="font-size:14px; font-weight:bold; color:#253858; letter-spacing:1px;">From</span>
                    <br/> 
                    <input style="background-color:#F0F0F0; border: 0px;padding: 13px 10px;text-align: center; width:33%;"type="text" name="text" value="{{$package->departure_airport_1}}">
                </td>
                <td style="width:33%;">
                    <span style="font-size:14px; font-weight:bold; color:#253858; letter-spacing:1px;">To</span>
                    <br/> 
                    <input style="background-color:#F0F0F0; border: 0px;padding: 13px 10px;text-align: center;width:33%;"type="text" name="text" value="{{$package->arrival_airport_1}}">
                </td>
                <td style="width:33%;">
                    <span style="font-size:14px; font-weight:bold; color:#253858; letter-spacing:1px; ">Flight</span>
                    <br/> 
            ...
            <tr>
                <td  style="width:33%;">
                    <span style="font-size:14px; font-weight:bold; color:#253858; letter-spacing:1px; ">Departure Date</span>
                    <br/>
                    <input style="background-color:#F0F0F0; border: 0px;padding: 13px 10px;text-align: center;width:33%;"type="text" name="text" value="{{$package->until}}">
                </td>
                <td style="width:33%;">
                    <span style="font-size:14px; font-weight:bold; color:#253858; letter-spacing:1px; ">Departure Time</span>
                    <br/>
                    <input style="background-color:#F0F0F0; border: 0px;padding: 13px 10px;text-align: center;width:33%;"type="text" name="text" value="{{$package->departure_time_1}}">
                </td>
                <td style="width:33%;">
                    <span style="font-size:14px; font-weight:bold; color:#253858; letter-spacing:1px; ">ArrivalTime</span>
                    <br/> 
                    <input style="background-color:#F0F0F0; border: 0px;padding: 13px 10px;text-align: center;width:33%;"type="text" name="text" value="{{$package->arrival_time_1}}">
                </td>
            </tr>
            <tr>
                <td  style="width:33%;">
                    <span style="font-size:14px; font-weight:bold; color:#253858; letter-spacing:1px; ">Airline</span>
                    <br/> 
                    <input style="background-color:#F0F0F0; border: 0px;padding: 13px 10px;text-align: center;width:33%;"type="text" name="text" value="{{$package->airline_1}}">
                </td>
                <td  style="width:33%;">
                    <span style="font-size:14px; font-weight:bold; color:#253858; letter-spacing:1px; ">Class</span>
                    <br/> 
