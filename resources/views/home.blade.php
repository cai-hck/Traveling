	...
	<div class="container">
		<div class="row">
			<div class="col-md-5">
				<div class="unique-details" style="text-align:right;">
					...
					<div class="two-types d-flex">
						...
						<li><h5>07722272999</h5><p>07722272888</p></li>
					</ul>
					<ul class="unique-hrs w-50">
						<li><img src="{{asset('addbyme1/images/add.png')}}" class="img-fluid"></li>
						<li><h5>العنوان</h5><p>المنصور
             ماكسي مول</p></li>
					</ul>
					</div>
				</div>
			...
			<div class="col-md-2 xs-align-right">
				<img src="{{asset('addbyme/images/logo.png')}}" class="img-fluid" style="padding-top: 80px;">
			</div>
		...
		<div class="footer-bottom">
			<div class="row">
				<div class="col-md-4 text-right">
					<p><i class="far fa-envelope ml-2 align-middle"></i>info@nabbaabaghdad.com</p>
				</div>
        ...
        <!--  <button type="button" class="close" data-dismiss="modal">&times;</button> -->
            <div class="modal-content"> 
                <div class="modal-header d-block">
                    <img src="{{asset('addbyme/images/logo.png')}}" class="img-fluid" style="margin-top:80px">
                </div>
                <!-- Modal body -->
                ...
                <div class="modal-body w-100 text-center"> 
                    <div class="row">
                        <div class="col-md-5 my-auto">
                            <img src="{{asset('addbyme/images/logo.png')}}" class="img-fluid">
                            <p class="verification" style="    font-size: 22px!important;   text-align: center!important">شركة نبع بغداد</p>
        ...
        <!--   <button type="button" class="close" data-dismiss="modal">&times;</button> -->
            <div class="modal-content"> 
                ...
                <div class="modal-header d-block">
                    ...
                    <img src="{{asset('addbyme/images/logo.png')}}" class="img-fluid" style="margin-top: 80px;">
                    <p class="verification booking1">شركة نبع بغداد</p>
                    <a href="#"><p class="small-text">استشكف عندنا افضل العروض</p></a>
                </div>
